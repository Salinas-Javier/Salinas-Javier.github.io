...
$headers.= "To: Sitio web <salinasjom@hotmail.com> \r\n";
...
//ASUNTO 
//CUERPO 
$rta = mail('salinasjom@hotmail.com', "Mensaje web: ", $body, $headers );
//var_dump($rta);
//$rta = mail('salinasjom@hotmail.com', "Mensaje web: $asunto", $body, $headers );
